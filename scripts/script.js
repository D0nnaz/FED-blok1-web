...
let counter = 1; /*hulp van Cheun Yin*/
...
setInterval(runMyNextFunction, 5000);
      ...
      // var foto1klein = document.querySelector(".insurance section:nth-of-type(5) img:nth-of-type(5)");
// var foto2klein = document.querySelector(".insurance section:nth-of-type(5) img:nth-of-type(6)");
// var foto3klein = document.querySelector(".insurance section:nth-of-type(5) img:nth-of-type(7)");
// var foto4klein = document.querySelector(".insurance section:nth-of-type(5) img:nth-of-type(8)");
// var knop1klein = document.querySelector(".insurance section:nth-of-type(6) a:nth-of-type(5)");
// var knop2klein = document.querySelector(".insurance section:nth-of-type(6) a:nth-of-type(6)");
// var knop3klein = document.querySelector(".insurance section:nth-of-type(6) a:nth-of-type(7)");
// var knop4klein = document.querySelector(".insurance section:nth-of-type(6) a:nth-of-type(8)");



// function eersteFotoKlein(){
//   foto1klein.style.display = "block";
//   foto2klein.style.display = "none";
// foto3klein.style.display = "none";
// foto4klein.style.display = "none";
// }
// knop1klein.addEventListener("click", eersteFotoKlein);

// function tweedeFotoKlein(){
//   foto1klein.style.display = "none";
//   foto2klein.style.display = "block";
// foto3klein.style.display = "none";
// foto4klein.style.display = "none";
// }
// knop2klein.addEventListener("click", tweedeFotoKlein);


// function derdeFotoKlein(){
//   foto1klein.style.display = "none";
//   foto2klein.style.display = "none";
// foto3klein.style.display = "block";
// foto4klein.style.display = "none";

// }knop3klein.addEventListener("click", derdeFotoKlein);


// function vierdeFotoKlein(){
//   foto1klein.style.display = "none";
//   foto2klein.style.display = "none";
// foto3klein.style.display = "none";
// foto4klein.style.display = "block";
// }
// knop4klein.addEventListener("click", vierdeFotoKlein);
...
// const myFunctions = [eersteFoto, tweedeFoto, derdeFoto, vierdeFoto,];
